...
const COMPANIES = {
  aise: {
    ...
    what:
      "AI Search Engineers positions businesses inside AI generated answers across ChatGPT, Google Gemini, and Microsoft Copilot. We do not chase rankings. We engineer authority, trust, and structured signals so AI systems recognize and select a business as the answer.",
    framework:
...
const PROFILES = {
  ...
  marium: {
    ...
    audience: "brands and businesses that want to be cited and recommended by AI search",
    fingerprint:
